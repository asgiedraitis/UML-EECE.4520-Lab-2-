...
serialDevFile = 'COM6' #Change this to COM port of Arduino device being used
ser=serial.Serial(serialDevFile, 9600, timeout=0) #Set this to the baud rate of the Arduino 
...
def check_controller():
    inp = ser.readline()
    inp_decode = inp.decode()
    command = inp_decode.rstrip()
...
while True:
    ...
    check_controller() #Update direction of snake
    ...
    if head.distance(food) < 20:
        ...
        ser.write(b'1') #Send que to controller that apple has been eaten
